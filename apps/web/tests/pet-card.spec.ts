...
const pet = (
  pet_allowed: string, confidence: number | null, evidence: string | null,
  caveats: string[], source_url: string | null,
) => ({
  pet_allowed, confidence, evidence, caveats, confirm_with_office: true,
