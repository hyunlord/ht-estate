...
export const CRITERIA_MOCK = {
  ...
  // filter-trim: major 플래그가 실 REGISTRY shape 미러. major=true만 기본 칩(헬스장·역세권·세대당주차).
  quick_filters: [
    { id: "subway_poi", label: "역세권 500m", apply: "hard",
      hard_field: "subway_max_dist_m", hard_value: 500, soft_key: null, major: true },
    { id: "parking_q", label: "세대당주차 1대+", apply: "hard",
      hard_field: "parking_ratio_gte", hard_value: 1.0, soft_key: null, major: true },
    { id: "gym_q", label: "헬스장", apply: "soft",
      hard_field: null, hard_value: null, soft_key: "gym", major: true },
    { id: "elem_school", label: "초등 500m", apply: "hard",
      hard_field: "elem_max_dist_m", hard_value: 500, soft_key: null, major: false },
    { id: "mart_poi", label: "마트 1km", apply: "hard",
      hard_field: "mart_count_1km_min", hard_value: 1, soft_key: null, major: false },
    { id: "conv_poi", label: "편의점 1km", apply: "hard",
      hard_field: "conv_count_1km_min", hard_value: 1, soft_key: null, major: false },
    { id: "hospital_poi", label: "병원 1km", apply: "hard",
      hard_field: "hospital_max_dist_m", hard_value: 1000, soft_key: null, major: false },
    { id: "park_poi", label: "공원 1km", apply: "hard",
      hard_field: "park_max_dist_m", hard_value: 1000, soft_key: null, major: false },
    { id: "has_daycare", label: "어린이집", apply: "soft",
      hard_field: null, hard_value: null, soft_key: "has_daycare", major: false },
    { id: "elevator", label: "엘베", apply: "soft",
      hard_field: null, hard_value: null, soft_key: "elevator_count", major: false },
    { id: "cctv", label: "CCTV", apply: "soft",
      hard_field: null, hard_value: null, soft_key: "cctv_count", major: false },
  ],
};
