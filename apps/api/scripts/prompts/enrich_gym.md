...
8. **계획/미래 금지(R1)** — "증설 추진·신축 예정·재건축 후 청사진·공사 중"은 **yes 금지**. 완공·운영이
   확인되기 전엔 **unknown**. (예: 리센츠 커뮤니티 증설 '추진' → 완공 확인 전 unknown.)
9. **명시적 헬스장 근거 요구(R2)** — generic "체육시설/커뮤니티" 표현만으론 yes 불가. evidence에
   **헬스장/피트니스/짐/GX/웨이트** 등 명시 근거가 있어야 yes. 위키(namu.wiki 등)는 **약한 근거**라
   confidence를 낮게(≤0.5).
